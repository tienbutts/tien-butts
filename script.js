...
L.marker([40.795429, -73.930289]).addTo(map) 
.bindPopup("<b>Costco: Harlem</b>").openPopup();

L.marker([40.767276, -73.937568]).addTo(map) 
.bindPopup("<b>Costco: Astoria</b>").openPopup(); 

L.marker([40.655620, -74.009233]).addTo(map) 
.bindPopup("<b>Costco: Brooklyn</b>").openPopup(); 

L.marker([40.645556,-74.011944]).addTo(map) 
.bindPopup("<b>Sunset Park</b>").openPopup();  

L.marker([40.765830, -73.833084]).addTo(map) 
.bindPopup("<b>Flushing</b>").openPopup(); 

L.marker([40.714722,-73.997222]).addTo(map) 
.bindPopup("<b>Chinatown</b>").openPopup(); 

L.marker([40.805187, -73.966378]).addTo(map) 
.bindPopup("<b>The Heights</b>").openPopup(); 

L.marker([40.723833, -74.004279]).addTo(map) 
.bindPopup("<b>Black Tap</b>").openPopup(); 

L.marker([40.714176, -73.986960]).addTo(map) 
